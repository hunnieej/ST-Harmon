...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_steps", default="False", help="whether to save intermediate steps.")
    parser.add_argument("--importance", default="False", help="whether to use importance-based permutation.")
