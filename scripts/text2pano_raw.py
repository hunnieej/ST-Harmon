# NOTE : Original script for generating single rectangular images
import torch
...
if __name__ == "__main__":
    ...
    input_ids = class_info['input_ids'] #torch.shape > torch.Size([2,24]) > input_ids랑 attention_mask 동일
    ...
    # NOTE grid = 2 > bsz = 4 > 1,024 x 1,024 image & grid = 1 > bsz = 1 > 512 x 512 image
    ...
    n = args.image_size*4 // 16 # 2:1 ratio
